...
COMMANDS = {
    ...
    "open our github profile": lambda: webbrowser.open("https://github.com"),
    "play my favourite song": lambda: webbrowser.open("https://www.youtube.com/watch?v=WPoiaEeoO6s"),
